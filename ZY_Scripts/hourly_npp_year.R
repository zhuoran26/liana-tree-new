...
########all the constants,make sure these are the same for all the functions
#make K and dbh
nK = 75000 
...
liana.NPP.mxh.hour = function(dbh, psis, D_vec, liana.k, SLA = NULL, b1 = NULL, 
  ...
  return(NPP,NPP_no_leaves)
}


liana_npp = rep(0,length(july_hourly_vpd))
...
#leaf dropping does impact the result the most
