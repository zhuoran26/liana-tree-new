## This script creates functions for the tree and liana model
## with atmospheric CO2 as an input rather than fixed
## Otherwise, these functions are identical to the regular model

## Date modified: 24 September 2021
## Author: AM Willson

# Rerun model with Ca as an input (instead of fixed in model)
tree.NPP.mxh.ca = function(tree.dbh, psis, D_vec, tree.k, SLA = NULL, b1 = NULL, b2 = NULL, nday, month, tot.al, frac.tree.al, tree.height, Vm = NULL, Ca){
...
liana.NPP.mxh.ca = function(dbh, psis, D_vec, liana.k, SLA = NULL, b1 = NULL, b2 = NULL, nday, month, tot.al, frac.liana.al, liana.length, Vm = NULL, Ca){
