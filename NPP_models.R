...
### Create new hour step models

## Tree model
tree.NPP.mxh = function(tree.dbh, psis, D_vec, tree.k, SLA = NULL, b1 = NULL, b2 = NULL, nday, month, tot.al, frac.tree.al, tree.height, Vm = NULL){
...
## Liana model
liana.NPP.mxh = function(dbh, psis, D_vec, liana.k, SLA = NULL, b1 = NULL, b2 = NULL, nday, month, tot.al, frac.liana.al, liana.length, Vm = NULL){
